...
Another thing to be aware of is that, since all the serial signals are handled on-board, they are not brought out to the edge connector. This shouldn't be a problem, as I'm not aware of any hardware besides serial adapters using them. If any odd peripheral uses any signals besides P1-P8, /ATTN and /RESET, it won't work. Please let me know if you happen to stumble into such a thing.
...
- If you use an original MOS 6529: replace D1-8 with 0-ohm resistors and do NOT mount RN1.
- If you use a 74LS654: replace D1-8 with 0-ohm resistors
